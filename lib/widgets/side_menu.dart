...
class _SideMenuState extends State<SideMenu> {
  ...
  Widget build(BuildContext context) {
    final items = <_NavItem>[
      ...
      _NavItem(NavIndex.dashboard,       'Dashboard',            Icons.show_chart_rounded, trailingHint: 'G+D'),
      _NavItem(NavIndex.orders,          'Orders',               Icons.shopping_cart_checkout_rounded, hasChildren: true),
      _NavItem(NavIndex.returns,         'Returns',              Icons.assignment_return_rounded),
      _NavItem(NavIndex.deliveryBoost,   'Delivery Boost',       Icons.local_shipping_rounded),
      _NavItem(NavIndex.quickInstant,    'Quick – Instant Delivery', Icons.speed_rounded),
      _NavItem(NavIndex.weightMgmt,      'Weight Management',    Icons.lock_rounded, hasChildren: true),
      _NavItem(NavIndex.buyerExperience, 'Buyer Experience',     Icons.groups_rounded, hasChildren: true),
      _NavItem(NavIndex.setupManage,     'Setup & Manage',       Icons.auto_awesome_mosaic_rounded, hasChildren: true),
      _NavItem(NavIndex.tools,           'Tools',                Icons.handyman_rounded, hasChildren: true),
...
class _NavTile extends StatelessWidget {
              ...
              children: item.children
                  .map(
                    (c) => InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      child: Container(
                        margin: const EdgeInsets.only(left: 58, right: 10, bottom: 4),
                        padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
                        decoration: BoxDecoration(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Icon(Icons.chevron_right_rounded,
                                  size: 16, color: SideMenu.navTextDim),
                            ),
  ...
  _TileBase _tileBase(bool selected) {
    final textColor = selected ? Colors.white : const Color.fromARGB(255, 0, 0, 0);
    final iconColor = selected ? Colors.white : AppColors.primary; // accent
    return _TileBase(
      textColor: textColor,
      iconColor: iconColor,
